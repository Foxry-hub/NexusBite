...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#menu" className="text-neutral-300 hover:text-orange-400 transition-colors">
                Menu
              </a>
              <a href="#fitur" className="text-neutral-300 hover:text-orange-400 transition-colors">
                Fitur
              </a>
              <a href="#cara-kerja" className="text-neutral-300 hover:text-orange-400 transition-colors">
                Cara Kerja
              </a>
            </div>
            <a
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-neutral-800/50 border border-neutral-700 rounded-full px-4 py-2 mb-6">
              <ChefHat className="w-4 h-4 text-orange-400" />
              <span className="text-sm text-neutral-300">E-Canteen untuk Sekolahmu</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                href="#cara-kerja"
                className="w-full sm:w-auto bg-neutral-800 hover:bg-neutral-700 text-white font-semibold px-8 py-4 rounded-full transition-all border border-neutral-700 flex items-center justify-center gap-2"
              >
                Lihat Cara Kerja
            ...
            <div className="grid grid-cols-3 gap-8 mt-16 max-w-lg mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-500">Siswa Aktif</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-400">15+</div>
                <div className="text-sm text-neutral-500">Stand Kantin</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-400">50+</div>
                <div className="text-sm text-neutral-500">Menu Tersedia</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Pickup Time Info */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-neutral-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-neutral-800 to-neutral-800/50 border border-neutral-700 rounded-2xl p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-400">09:30 - 10:00 WIB</p>
                <p className="text-sm text-neutral-500">Pesan sebelum 09:00</p>
              </div>
            </div>
            <div className="bg-gradient-to-br from-neutral-800 to-neutral-800/50 border border-neutral-700 rounded-2xl p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-400">12:00 - 12:30 WIB</p>
                <p className="text-sm text-neutral-500">Pesan sebelum 11:30</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {trendingMenus.map((menu) => (
              <div
                key={menu.id}
                className="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden hover:border-orange-500/50 transition-all hover:shadow-xl hover:shadow-orange-500/10 group"
              >
                {/* Image placeholder */}
                <div className="relative h-48 bg-gradient-to-br from-neutral-800 to-neutral-700 overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Utensils className="w-16 h-16 text-neutral-600 group-hover:text-orange-500/50 transition-colors" />
                  </div>
                  {/* Rating badge */}
                  <div className="absolute top-3 right-3 bg-neutral-900/80 backdrop-blur-sm rounded-full px-2.5 py-1 flex items-center gap-1">
      ...
      {/* Features Section */}
      <section id="fitur" className="py-20 px-4 sm:px-6 lg:px-8 bg-neutral-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              Fitur{" "}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Saldo Virtual */}
            <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 rounded-2xl p-8 text-center hover:border-orange-500/50 transition-all group">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative group">
              <div className="text-6xl font-bold text-neutral-800 absolute -top-4 -left-2 z-0 -rotate-12 transition-all duration-500 ease-out group-hover:z-20 group-hover:rotate-0 group-hover:text-orange-500 group-hover:drop-shadow-[0_0_10px_rgba(249,115,22,0.5)]">1</div>
              <div className="relative z-10 bg-neutral-900 border border-neutral-800 rounded-2xl p-6 pt-8 transition-all group-hover:border-orange-500/50">
            ...
            <div className="relative group">
              <div className="text-6xl font-bold text-neutral-800 absolute -top-4 -left-2 z-0 rotate-12 transition-all duration-500 ease-out group-hover:z-20 group-hover:rotate-0 group-hover:text-orange-500 group-hover:drop-shadow-[0_0_10px_rgba(249,115,22,0.5)]">2</div>
              <div className="relative z-10 bg-neutral-900 border border-neutral-800 rounded-2xl p-6 pt-8 transition-all group-hover:border-orange-500/50">
            ...
            <div className="relative group">
              <div className="text-6xl font-bold text-neutral-800 absolute -top-4 -left-2 z-0 -rotate-12 transition-all duration-500 ease-out group-hover:z-20 group-hover:rotate-0 group-hover:text-orange-500 group-hover:drop-shadow-[0_0_10px_rgba(249,115,22,0.5)]">3</div>
              <div className="relative z-10 bg-neutral-900 border border-neutral-800 rounded-2xl p-6 pt-8 transition-all group-hover:border-orange-500/50">
      ...
      <section id="join" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-orange-500 to-amber-500 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden">
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-40 h-40 bg-white/10 rounded-full -tranneutral-y-1/2 tranneutral-x-1/2" />
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-white/10 rounded-full tranneutral-y-1/2 -tranneutral-x-1/2" />
            ...
            <div className="relative">
              ...
              <a
                href="/login"
                className="inline-flex items-center gap-2 bg-neutral-900 hover:bg-neutral-800 text-white font-bold px-8 py-4 rounded-full transition-all hover:shadow-xl text-lg"
              >
